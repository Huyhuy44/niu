...
async function main() {
    ...
    const proxyscrape = await axios.get('https://www.proxy-list.download/api/v1/get?type=http');
    const proxyscrape = await axios.get('https://www.proxyscan.io/download?type=http');
    const proxyscrape = await axios.get('https://api.openproxylist.xyz/http.txt');
    const proxyscrape = await axios.get('http://www.my-proxy.com/free-proxy-list.html');
